...
/// each linear edge to its 180� curves. Each 180� curve is approximately half
/// an ellipse.
///
/// In this shape, the curvature of each 180� curve around the length of the arc
...
/// side.
///
/// The two 180� arcs will always be positioned on the shorter side of the
...
class SquircleStadiumBorder extends ShapeBorder {
  ...
  Path _getPath(final Rect rectangle) {
    ...
    // An elliptical shape with 2 straight edges and two 180� curves. The width
    ...
    // An elliptical shape which has 2 straight edges and two 180� curves. The
