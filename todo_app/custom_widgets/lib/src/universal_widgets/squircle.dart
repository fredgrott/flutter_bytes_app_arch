...
/// shape, the curvature of each 90� corner around the length of the arc is
...
///
/// This shape will always have 4 linear edges and 4 90� curves. However, for
...
///   continuous transition into its two 180� curves.
...
class SquircleBorder extends ShapeBorder {
  ...
  Path _getPath(Rect rect) {
    ...
    // 4 straight edges and 4 90� corners. Approximately renders a superellipse
